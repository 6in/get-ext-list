...
/* Command for C compiler:
   gcc -c  -w  -I/opt/apps/nim/nim-0.17.0/lib -o /mnt/pcie/workspaces/workspace-nim/get_ext_list/src/nimcache/stdlib_tables.o /mnt/pcie/workspaces/workspace-nim/get_ext_list/src/nimcache/stdlib_tables.c */
...
static N_NIMCALL(void, Marker_TY_Tl2uHUsuLSQf9bN9bZowWv4Q)(void* p, NI op);
...
TNimType NTI_mGuTghb7gdfMB1AQA9bfeJw_;
extern TNimType NTI_rR5Bzr1D5krxoo1NcNyeMA_;
extern TNimType NTI_77mFvmsOLKik79ci2hXkHEg_;
extern TNimType NTI_9bzblIv39b19bLtyTzpVFK81g_;
TNimType NTI_Tl2uHUsuLSQf9bN9bZowWv4Q_;
...
TNimType NTI_8Uf9bmzgz4A6eZu5h8HqdYA_;
...
static N_NIMCALL(void, Marker_TY_Tl2uHUsuLSQf9bN9bZowWv4Q)(void* p, NI op) {
	TY_Tl2uHUsuLSQf9bN9bZowWv4Q* a;
	NI T1_;
	a = (TY_Tl2uHUsuLSQf9bN9bZowWv4Q*)p;
	T1_ = (NI)0;
...
N_NIMCALL(void, initTable_dOIBg8E67Yg7t5EIsoQ9aHA)(NI initialSize, Table_8Uf9bmzgz4A6eZu5h8HqdYA* Result) {
	...
	unsureAsgnRef((void**) (&(*Result).data), (TY_Tl2uHUsuLSQf9bN9bZowWv4Q*) newSeq((&NTI_Tl2uHUsuLSQf9bN9bZowWv4Q_), ((NI)chckRange(initialSize, ((NI) 0), ((NI) IL64(9223372036854775807))))));
	popFrame();
}
...
N_NIMCALL(NIM_BOOL, hasKey_mfFNyKdgINDteTqTsOLSEg_2)(Table_8Uf9bmzgz4A6eZu5h8HqdYA t, NimStringDesc* key) {
	...
	T1_ = (NI)0;
	T1_ = rawGet_9bnUTGHGTuHO3gGzrEbHDLgtables(t, key, (&hc));
	result = (((NI) 0) <= T1_);
	popFrame();
	return result;
}
...
{	result = (NIM_BOOL)0;
	...
	result = hasKey_mfFNyKdgINDteTqTsOLSEg_2(t, key);
	goto BeforeRet_;
	}BeforeRet_: ;
	popFrame();
	return result;
...
N_NIMCALL(void, enlarge_rNdZQ4agBlNdtMX39bhshmg)(Table_8Uf9bmzgz4A6eZu5h8HqdYA* t) {
	TY_Tl2uHUsuLSQf9bN9bZowWv4Q* n;
	NI TM_4SoG2KRQy3oMm9aUzSLtGrA_13;
	TY_Tl2uHUsuLSQf9bN9bZowWv4Q* T1_;
	nimfr_("enlarge", "tables.nim")
	n = (TY_Tl2uHUsuLSQf9bN9bZowWv4Q*)0;
	nimln_(286, "tables.nim");
	TM_4SoG2KRQy3oMm9aUzSLtGrA_13 = mulInt(((*t).data ? (*t).data->Sup.len : 0), ((NI) 2));
	n = (TY_Tl2uHUsuLSQf9bN9bZowWv4Q*) newSeq((&NTI_Tl2uHUsuLSQf9bN9bZowWv4Q_), ((NI)chckRange((NI)(TM_4SoG2KRQy3oMm9aUzSLtGrA_13), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	nimln_(287, "tables.nim");
	T1_ = (TY_Tl2uHUsuLSQf9bN9bZowWv4Q*)0;
	T1_ = (*t).data;
		...
		res = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln_(290, "tables.nim");
				{
					...
					if ((NU)(i) >= (NU)(n->Sup.len)) raiseIndexError();
					if ((NU)(i) >= (NU)(n->Sup.len)) raiseIndexError();
					rawInsert_PEFjCnre9brgFg4bozkOH8w(t, (&(*t).data), n->data[i].Field1, n->data[i].Field2, eh, j);
				}
				LA8_: ;
...
N_NIMCALL(void, X5BX5Deq__3D7DhGkFWUzQM9auF2Bibyg)(Table_8Uf9bmzgz4A6eZu5h8HqdYA* t, NimStringDesc* key, TY_9bzblIv39b19bLtyTzpVFK81g val) {
	...
	index = rawGet_9bnUTGHGTuHO3gGzrEbHDLgtables((*t), key, (&hc));
	...
	LA3_: ;
	{
		...
		nimln_(89, "tableimpl.nim");
		{
			...
			enlarge_rNdZQ4agBlNdtMX39bhshmg(t);
			nimln_(91, "tableimpl.nim");
			index = rawGetKnownHC_7x9ckJURtS0mgZKGnBgeeuAtables((*t), key, hc);
		}
		LA9_: ;
		...
		rawInsert_PEFjCnre9brgFg4bozkOH8w(t, (&(*t).data), key, val, hc, index);
...
N_NIMCALL(TY_9bzblIv39b19bLtyTzpVFK81g*, X5BX5D__bMIBZN5tX7RVZpP2qmV9cZQ)(Table_8Uf9bmzgz4A6eZu5h8HqdYA* t, NimStringDesc* key) {
	TY_9bzblIv39b19bLtyTzpVFK81g* result;
	NI hc;
	NI index;
	nimfr_("[]", "tables.nim")
	result = (TY_9bzblIv39b19bLtyTzpVFK81g*)0;
	hc = (NI)0;
...
NTI_mGuTghb7gdfMB1AQA9bfeJw_.size = sizeof(TY_mGuTghb7gdfMB1AQA9bfeJw);
NTI_mGuTghb7gdfMB1AQA9bfeJw_.kind = 18;
NTI_mGuTghb7gdfMB1AQA9bfeJw_.base = 0;
NTI_mGuTghb7gdfMB1AQA9bfeJw_.flags = 2;
TM_4SoG2KRQy3oMm9aUzSLtGrA_11[0] = &TM_4SoG2KRQy3oMm9aUzSLtGrA_0[1];
TM_4SoG2KRQy3oMm9aUzSLtGrA_0[1].kind = 1;
TM_4SoG2KRQy3oMm9aUzSLtGrA_0[1].offset = offsetof(TY_mGuTghb7gdfMB1AQA9bfeJw, Field0);
...
TM_4SoG2KRQy3oMm9aUzSLtGrA_0[2].offset = offsetof(TY_mGuTghb7gdfMB1AQA9bfeJw, Field1);
...
TM_4SoG2KRQy3oMm9aUzSLtGrA_0[3].offset = offsetof(TY_mGuTghb7gdfMB1AQA9bfeJw, Field2);
TM_4SoG2KRQy3oMm9aUzSLtGrA_0[3].typ = (&NTI_9bzblIv39b19bLtyTzpVFK81g_);
...
NTI_mGuTghb7gdfMB1AQA9bfeJw_.node = &TM_4SoG2KRQy3oMm9aUzSLtGrA_0[0];
NTI_Tl2uHUsuLSQf9bN9bZowWv4Q_.size = sizeof(TY_Tl2uHUsuLSQf9bN9bZowWv4Q*);
NTI_Tl2uHUsuLSQf9bN9bZowWv4Q_.kind = 24;
NTI_Tl2uHUsuLSQf9bN9bZowWv4Q_.base = (&NTI_mGuTghb7gdfMB1AQA9bfeJw_);
NTI_Tl2uHUsuLSQf9bN9bZowWv4Q_.flags = 2;
NTI_Tl2uHUsuLSQf9bN9bZowWv4Q_.marker = Marker_TY_Tl2uHUsuLSQf9bN9bZowWv4Q;
NTI_8Uf9bmzgz4A6eZu5h8HqdYA_.size = sizeof(Table_8Uf9bmzgz4A6eZu5h8HqdYA);
NTI_8Uf9bmzgz4A6eZu5h8HqdYA_.kind = 18;
NTI_8Uf9bmzgz4A6eZu5h8HqdYA_.base = 0;
NTI_8Uf9bmzgz4A6eZu5h8HqdYA_.flags = 2;
TM_4SoG2KRQy3oMm9aUzSLtGrA_19[0] = &TM_4SoG2KRQy3oMm9aUzSLtGrA_0[5];
TM_4SoG2KRQy3oMm9aUzSLtGrA_0[5].kind = 1;
TM_4SoG2KRQy3oMm9aUzSLtGrA_0[5].offset = offsetof(Table_8Uf9bmzgz4A6eZu5h8HqdYA, data);
TM_4SoG2KRQy3oMm9aUzSLtGrA_0[5].typ = (&NTI_Tl2uHUsuLSQf9bN9bZowWv4Q_);
TM_4SoG2KRQy3oMm9aUzSLtGrA_0[5].name = "data";
TM_4SoG2KRQy3oMm9aUzSLtGrA_19[1] = &TM_4SoG2KRQy3oMm9aUzSLtGrA_0[6];
TM_4SoG2KRQy3oMm9aUzSLtGrA_0[6].kind = 1;
TM_4SoG2KRQy3oMm9aUzSLtGrA_0[6].offset = offsetof(Table_8Uf9bmzgz4A6eZu5h8HqdYA, counter);
TM_4SoG2KRQy3oMm9aUzSLtGrA_0[6].typ = (&NTI_rR5Bzr1D5krxoo1NcNyeMA_);
TM_4SoG2KRQy3oMm9aUzSLtGrA_0[6].name = "counter";
TM_4SoG2KRQy3oMm9aUzSLtGrA_0[4].len = 2; TM_4SoG2KRQy3oMm9aUzSLtGrA_0[4].kind = 2; TM_4SoG2KRQy3oMm9aUzSLtGrA_0[4].sons = &TM_4SoG2KRQy3oMm9aUzSLtGrA_19[0];
NTI_8Uf9bmzgz4A6eZu5h8HqdYA_.node = &TM_4SoG2KRQy3oMm9aUzSLtGrA_0[4];
}
