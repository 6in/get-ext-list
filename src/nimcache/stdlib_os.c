...
/* Command for C compiler:
   gcc -c  -w  -I/opt/apps/nim/nim-0.17.0/lib -o /mnt/pcie/workspaces/workspace-nim/get_ext_list/src/nimcache/stdlib_os.o /mnt/pcie/workspaces/workspace-nim/get_ext_list/src/nimcache/stdlib_os.c */
...
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_5, "\012Additional info: ", 18);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_6, "unknown OS error", 16);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_7, "\012  not (path == \"\") ", 20);
...
appendString(T6_, ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_5));
appendString(T6_, additionalInfo);
	...
	nimln_(152, "os.nim");
	{
		...
		T12_ = (*e).Sup.Sup.message; (*e).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_6));
...
N_NIMCALL(NI64, nosgetFileSize)(NimStringDesc* file) {
	...
	nimln_(1657, "os.nim");
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = open_sEp0GH2306oGo9bqBpj5oTQ(&f, file, ((FileMode_fVUBHvW79bXUw1j55Oo9avSQ) 0), ((NI) -1));
		if (!T3_) goto LA4_;
		nimln_(1658, "os.nim");
	...
	LA4_: ;
	{
		...
		nimln_(1660, "os.nim");
		T7_ = (NI32)0;
		T7_ = osLastError_YyC2FKP9bqQiUDq2XVqW9acA();
...
N_NIMCALL(PathComponent_9c1SIU9cO1wHcl09b703A9cDrg, getSymlinkFileKind_WoXOp8qmMec1P4MyA3LBKg)(NimStringDesc* path) {
	...
	nimln_(941, "os.nim");
	{
		...
		failedAssertImpl_aDmpBTs9cPuXp0Mp9cfiNeyA(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_7));
	}
	LA3_: ;
	nimln_(942, "os.nim");
	{
		...
		raiseOSError_86HIIOlD5N61CWaO5GBgqA(T10_, ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_4));
	}
	LA8_: ;
	nimln_(944, "os.nim");
	{
