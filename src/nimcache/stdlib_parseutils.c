...
/* Command for C compiler:
   gcc -c  -w  -I/opt/apps/nim/nim-0.17.0/lib -o /mnt/pcie/workspaces/workspace-nim/get_ext_list/src/nimcache/stdlib_parseutils.o /mnt/pcie/workspaces/workspace-nim/get_ext_list/src/nimcache/stdlib_parseutils.c */
